...
class BusinessProfile(BaseModel):
    ...
    bank_accounts: Mapped[dict[str, Any] | None] = mapped_column(JSONB, nullable=True)
    shipping_information: Mapped[dict[str, Any] | None] = mapped_column(JSONB, nullable=True)
    courier_methods: Mapped[dict[str, Any] | None] = mapped_column(JSONB, nullable=True)
    ...
    contact_admin_info: Mapped[dict[str, Any] | None] = mapped_column(JSONB, nullable=True)
