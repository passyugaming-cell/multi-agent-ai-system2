...
**Remote PR HEAD Verification**: Remote PR HEAD must be verified externally against GitHub at review time. The report intentionally does not embed its own final Git commit SHA because a commit cannot cryptographically self-contain its own final SHA.
