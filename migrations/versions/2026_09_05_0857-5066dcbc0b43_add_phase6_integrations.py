...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_integration_connections_integration_id'), 'integration_connections', ['integration_id'], unique=False)
    op.create_index(op.f('ix_integration_connections_provider_key'), 'integration_connections', ['provider_key'], unique=False)
    ...
    op.create_index(op.f('ix_integration_executions_connection_id'), 'integration_executions', ['connection_id'], unique=False)
    op.create_index(op.f('ix_integration_executions_correlation_id'), 'integration_executions', ['correlation_id'], unique=False)
    op.create_index(op.f('ix_integration_executions_idempotency_key'), 'integration_executions', ['idempotency_key'], unique=False)
    op.create_index(op.f('ix_integration_executions_status'), 'integration_executions', ['status'], unique=False)
    op.create_index(op.f('ix_integration_executions_tenant_id'), 'integration_executions', ['tenant_id'], unique=False)
    ...
    op.create_index(op.f('ix_webhook_configs_connection_id'), 'webhook_configs', ['connection_id'], unique=False)
